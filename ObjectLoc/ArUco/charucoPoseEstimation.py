...
def main():
    ...
    parser.add_argument("-w", help="Number of squares in X direction", default="6", action="store", dest="w", type=int)
    parser.add_argument("-h", help="Number of squares in Y direction", default="4", action="store", dest="h", type=int)
    parser.add_argument("-sl", help="Square side length", default="1.", action="store", dest="sl", type=float)
    parser.add_argument("-ml", help="Marker side length", default="0.8", action="store", dest="ml", type=float)
