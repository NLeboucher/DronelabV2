...
\subtitle{A modular and scalable platform for swarm drones control}
...
\titlehead{\centering\includegraphics[width=6cm]{dvic.png}}

\publishers{\textbf{Supervisors}\\ Dr Xiao Xiao and Dr Marc Teyssier Professors at the Institute for Future Technologies }
...
\include{chapters/contribution1}

\include{chapters/contribution2}

\include{chapters/contribution3}

\include{chapters/zconclusion}
...
% Define your terms
% add a new glossary entry on stateless
\newglossaryentry{stateless}{
    name={stateless},
    description={A system that does not retain information between requests.}
}
...
\newglossaryentry{DCK}{
    name={DCK},
    description={Drone Control Kernel (a module for swarm drones control).}
}
\newglossaryentry{HLK}{
    name={HLK},
    description={Human Localization Kernel (a module for human localization and pose estimation).}
}
\newglossaryentry{lighthouse}{
    name={Lighthouse},
    description={A base station used for tracking the position of VR devices.}
}
\newglossaryentry{CRPA}{
    name={CRPA},
    description={Crazy Radio PA (a radio dongle used to communicate with Crazyflie drones).}
}

\newglossaryentry{UAV}{
    name={UAV},
    description={Unmanned Aerial Vehicle (a drone).}
}
\newglossaryentry{drone}{
    name={drone},
    description={An unmanned aerial vehicle (UAV) or unmanned aircraft system (UAS).}
}
\newglossaryentry{fpsLabel}{
    name={FPS},
    description={Frames Per Second (a measure of how well a game or video can run).}
}
% Make a new entry for FPV
\newglossaryentry{FPV}{
    name={FPV},
    description={First Person View (a method used to control drones by seeing through their cameras).}
}
\newglossaryentry{RGB}{
    name={RGB},
...
\printglossary[title=Special Terms, toctitle=Special Terms] % Output the glossary, 'title' is the chapter heading for the glossary, toctitle is the table of contents heading
