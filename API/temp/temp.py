...
def estimate_geometry(origin: LhCfPoseSample,
    ...
    print("USER ADDED : cf_aligned_poses: ", cf_aligned_poses)
    with open('CF_Aligned_POSES.pickle', 'wb') as handle:
        pickle.dump(cf_aligned_poses, handle, protocol=pickle.HIGHEST_PROTOCOL)
    # Scale the solution
